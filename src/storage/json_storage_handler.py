...
SOURCE_METADATA = {
    ...
    "statcounter-in": {
        "id": "statcounter-in",
        "name": "StatCounter India",
        "description": "Desktop OS market share based on web traffic analysis (India)",
        "url": "https://gs.statcounter.com/os-market-share/desktop/india",
        "methodology": "Aggregated web traffic from millions of websites in India",
        "covers": "desktop",
        "region": "in",
    },
    "statcounter-jp": {
        "id": "statcounter-jp",
        "name": "StatCounter Japan",
        "description": "Desktop OS market share based on web traffic analysis (Japan)",
        "url": "https://gs.statcounter.com/os-market-share/desktop/japan",
        "methodology": "Aggregated web traffic from millions of websites in Japan",
        "covers": "desktop",
        "region": "jp",
    },
    "statcounter-br": {
        "id": "statcounter-br",
        "name": "StatCounter Brazil",
        "description": "Desktop OS market share based on web traffic analysis (Brazil)",
        "url": "https://gs.statcounter.com/os-market-share/desktop/brazil",
        "methodology": "Aggregated web traffic from millions of websites in Brazil",
        "covers": "desktop",
        "region": "br",
    },
    "statcounter-na": {
        ...
        combined = {
            "metadata": {
                ...
                "fields": ["linux_share", "windows_share", "mac_share", "chromeos_share", "wsl_share", "other_share",
                           "unknown_share", "linux_share_adj", "windows_share_adj", "mac_share_adj", "chromeos_share_adj"],
            },
            "data": all_data,
        }
